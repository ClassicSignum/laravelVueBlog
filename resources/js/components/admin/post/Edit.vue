            ...
            <div class="row justify-content-around">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <form role="form" action="" v-on:submit.prevent="updatePost" enctype="multipart/form-data" >

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="postId">Edit post</label>
                                    <input v-model="form.title" name="title" placeholder="Edit post"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea v-model="form.description" name="description" placeholder="Edit description"
                                ...
                                <div class="form-group">
                                    <label for="photoId">Edit photo</label>
                                    ...
                                    <img :src="updateImage()" height="110px" alt="">
